...
var privateCrt = fs.readFileSync(path.join(process.cwd(), 'lihuyong.cn_bundle.crt'), 'utf8');
var privateKey = fs.readFileSync(path.join(process.cwd(), 'lihuyong.cn.key'), 'utf8');
const HTTPS_OPTOIN = {
  key: privateKey,
  cert: privateCrt
};
...
var http_server = https.createServer(HTTPS_OPTOIN, app);
// http_server.listen(3003);

const SSL_PORT = 443;
http_server.listen(SSL_PORT,'0.0.0.0', () => {
